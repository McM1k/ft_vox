...
pub fn get_swapchains_dimensions(window: &Window) -> [u32; 2] {
...
fn main() {
    ...
    let instance = {
        // When we create an instance, we have to pass a list of extensions that e want to enable.
        //
    ...
    let (mut swapchain, images) = {
        ...
        let initial_dimensions = get_swapchains_dimensions(window);
...
"
    ...
    loop {
        ...
        if recreate_swapchain {
            ...
            let dimensions = get_swapchains_dimensions(window);
        ...
        let (image_num,_bool , acquire_future) = match swapchain::acquire_next_image(swapchain.clone(), None) {
            Ok(r) => r,
